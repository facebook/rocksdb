This is the old version of the Performance Benchmarks wiki content. The new version [is here](https://github.com/facebook/rocksdb/wiki/Performance-Benchmarks).
