...
| External Log Files | [external_log_files.md](external_log_files.md) | Experimental MANIFEST-tracked byte streams, lifecycle semantics, recovery, visibility, and synchronization. |
