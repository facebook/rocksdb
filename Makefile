...
ifndef DISABLE_JEMALLOC
	...
	# JEMALLOC_INCLUDE and JEMALLOC_LIB are forced in the Facebook
	# internal build.
	PLATFORM_CXXFLAGS += $(JEMALLOC_INCLUDE)
	EXEC_LDFLAGS := $(JEMALLOC_LIB) $(MALLOC_LIB) $(EXEC_LDFLAGS)
endif

ifeq ($(PLATFORM_WEAK_SYMBOLS),true)
    PLATFORM_CXXFLAGS += -DROCKSDB_WEAK_SYMBOLS
    PLATFORM_CCFLAGS +=  -DROCKSDB_WEAK_SYMBOLS
endif
