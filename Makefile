...
zlib-$(ZLIB_VER).tar.gz:
	curl --fail --insecure --output zlib-$(ZLIB_VER).tar.gz --location ${ZLIB_DOWNLOAD_BASE}/zlib-$(ZLIB_VER).tar.gz
...
bzip2-$(BZIP2_VER).tar.gz:
	curl --fail --insecure --output bzip2-$(BZIP2_VER).tar.gz --location ${CURL_SSL_OPTS} ${BZIP2_DOWNLOAD_BASE}/bzip2-$(BZIP2_VER).tar.gz
...
snappy-$(SNAPPY_VER).tar.gz:
	curl --fail --insecure --output snappy-$(SNAPPY_VER).tar.gz --location ${CURL_SSL_OPTS} ${SNAPPY_DOWNLOAD_BASE}/$(SNAPPY_VER).tar.gz
...
lz4-$(LZ4_VER).tar.gz:
	curl --fail --insecure --output lz4-$(LZ4_VER).tar.gz --location ${CURL_SSL_OPTS} ${LZ4_DOWNLOAD_BASE}/v$(LZ4_VER).tar.gz
...
zstd-$(ZSTD_VER).tar.gz:
	curl --fail --insecure --output zstd-$(ZSTD_VER).tar.gz --location ${CURL_SSL_OPTS} ${ZSTD_DOWNLOAD_BASE}/v$(ZSTD_VER).tar.gz
