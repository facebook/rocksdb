...
const std::array<double, 18> BandingConfigHelperData<
    kOneIn2, 128U, /*smash*/ true>::kKnownToAddByPow2 = {
...
template <>
const std::array<double, 18> BandingConfigHelperData<
    kOneIn20, 128U, /*smash*/ true>::kKnownToAddByPow2 = {
    0,       0,       0,       0,       0,       0,      0,  // unsupported
...
template <>
const std::array<double, 18> BandingConfigHelperData<
    kOneIn20, 64U, /*smash*/ true>::kKnownToAddByPow2 = {
    0,       0,       0,       0,       0,       0,  // unsupported
...
template <>
const std::array<double, 18> BandingConfigHelperData<
    kOneIn1000, 64U, /*smash*/ true>::kKnownToAddByPow2 = {
    0,       0,       0,       0,       0,       0,  // unsupported
