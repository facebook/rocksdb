...
class BuiltinLZ4CompressorV2 : public CompressorWithSimpleDictBase {
 public:
  ...
  Status CompressBlock(Slice uncompressed_data, char* compressed_output,
    ...
    // TODO: use better/faster LZ4 APIs, including with LZ4_STATIC_LINKING_ONLY
...
class BuiltinLZ4HCCompressorV2 : public CompressorWithSimpleDictBase {
 public:
  ...
  Status CompressBlock(Slice uncompressed_data, char* compressed_output,
    ...
    // TODO: use better/faster LZ4 APIs, including with
    // LZ4_HC_STATIC_LINKING_ONLY See
    // https://github.com/lz4/lz4/blob/dev/lib/lz4hc.h
