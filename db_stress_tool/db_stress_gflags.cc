...
DEFINE_int32(
    ingest_live_db_file_one_in, 0,
    "If non-zero, then for every N TestIngestExternalFile(), we will try to do"
    " one that ingests files generated by a live DB instead of SstFileWriter.");
