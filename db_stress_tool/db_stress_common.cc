...
static void ProcessCompactionResult(
    ...
    StressTest* stress_test, uint64_t& successful_compaction_end_to_end_micros,
    uint64_t start_micros, Env* env) {
...
static void ProcessRemoteCompactionJob(
  ...
  ProcessCompactionResult(s, job_id, job_info, serialized_input,
                          ...
                          stress_test, successful_compaction_end_to_end_micros,
                          start_micros, options.env);
}
