...
DECLARE_uint32(num_partitioned_wal_writers);
DECLARE_string(partitioned_wal_consistency_mode);
DECLARE_uint64(partitioned_wal_sync_interval_ms);
DECLARE_uint64(partitioned_wal_max_file_size);
