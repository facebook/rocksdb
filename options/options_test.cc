...
TEST_F(OptionsTest, PartitionWALUsageComposeImmutable) {
  ...
  for (PartitionWALUsage usage :
       {PartitionWALUsage::kNone, PartitionWALUsage::kWALIndexSingleFile,
...
TEST_F(OptionsTest, PartitionWALUsageFromString) {
  ...
  const std::vector<std::pair<std::string, PartitionWALUsage>> kCases = {
      ...
      {"kWALIndexSingleFile", PartitionWALUsage::kWALIndexSingleFile},
      {"wal_index_single_file", PartitionWALUsage::kWALIndexSingleFile},
      {"kWALIndexPartitionByColumnFamily",
       PartitionWALUsage::kWALIndexPartitionByColumnFamily},
      {"wal_index_partition_by_column_family",
       PartitionWALUsage::kWALIndexPartitionByColumnFamily}};
