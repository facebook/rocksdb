...
TEST_F(OptionsTest, GetBlockBasedTableOptionsFromString) {
  ...
  ASSERT_OK(GetBlockBasedTableOptionsFromString(
      ...
      // A test for a hack. A bug caused read_amp_bytes_per_bit to be a large
      // integer in OPTIONS file generated by 6.10 to 6.14. Though bug is
      // fixed in these releases, we need to handle the case of loading
      // OPTIONS file generated before the fix.
