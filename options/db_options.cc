    ...
    db_mutable_options_type_info = {
        ...
        {"max_total_wal_size",
         {offsetof(struct MutableDBOptions, max_total_wal_size),
          ...
          OptionTypeFlags::kMutable}},
        {"enable_trace",
         {offsetof(struct MutableDBOptions, enable_trace), OptionType::kBoolean,
          OptionVerificationType::kNormal, OptionTypeFlags::kMutable}},
        {"trace_is_on",
         {offsetof(struct MutableDBOptions, trace_is_on), OptionType::kBoolean,
          OptionVerificationType::kNormal, OptionTypeFlags::kMutable}},
        {"trace_name_postfix",
         {offsetof(struct MutableDBOptions, trace_name_postfix),
