    ...
    db_immutable_options_type_info = {
        ...
        {"is_fd_close_on_exec",
         {offsetof(struct ImmutableDBOptions, is_fd_close_on_exec),
          ...
          OptionTypeFlags::kNone}},
        {"paranoid_checks",
         {offsetof(struct ImmutableDBOptions, paranoid_checks), OptionType::kBoolean,
          OptionVerificationType::kNormal, OptionTypeFlags::kNone, 0}},
        {"track_and_verify_wals_in_manifest",
         {offsetof(struct ImmutableDBOptions, track_and_verify_wals_in_manifest), OptionType::kBoolean,
          OptionVerificationType::kNormal, OptionTypeFlags::kNone, 0}},
