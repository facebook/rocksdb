...
* Fixed a bug which causes hang in closing DB when refit level is set in opt build. It was because ConitnueBackgroundWork() was called in assert statement which is a no op. It was introduced in 6.14.
