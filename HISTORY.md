...
* When `stats_dump_period_sec > 0`, the first dump is staggered in the interval `[0, stats_dump_period_sec)` seconds after the DB opens. Subsequent dumps are still spaced `stats_dump_period_sec` seconds apart.
