...
* Replace global variable `IOStatsContext iostats_context` with `IOStatsContext* get_iostats_context()`
* Replace global variable `PerfContext perf_context` with `PerfContext* get_perf_context()`
