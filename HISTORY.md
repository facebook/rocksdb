...
* Replace dynamic_cast<> (except unit test) so people can choose to build with RTTI off. With make, release build is by default built with -fno-rtti. Users can override it by setting USE_RTTI=1.
