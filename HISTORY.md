...
### Public API Change
* Extensions to the ObjectRegistry interface.  Added ability to register a set of functions with a library.  Added ability to register libraries with the registry.  Added methods to query the names/types of factories installed in a registry.
