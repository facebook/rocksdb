...
### Public API Change
* Re-enable WAL recycling (`recycle_log_file_num`) when `kPointInTimeRecovery` or `kAbsoluteConsistency` recovery mode is requested. WAL recycling has been disabled with these recovery modes since RocksDB 6.8.
