...
* The default value of `force_consistency_checks` is now true. It may impact background work CPU for users with compactions involving large number of files or huge keys or both.
