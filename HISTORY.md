...
* Add a new field `level_of_creation` in `TablePropertiesCollectorFactory::Context` to capture the level when creating the SST file (i.e, table), of which the properties are being collected.
