...
* Added new perf context counters `block_cache_standalone_handle_count`, `secondary_cache_insert_real_count`, `secondary_cache_insert_dummy_count`, `secondary_cache_insert_uncompressed_bytes`, and `secondary_cache_insert_compressed_bytes`.
