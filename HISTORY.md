...
* Added hash checks for data written to SST files to prevent persisting corrupted data. Users can set option `paranoid_checks` to make rocksdb to read back written data for extra hash checks.  
