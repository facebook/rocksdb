...
* Fixed a bug where stalled writes would remain stalled forever after calling `WriteBufferManager::SetBufferSize()` with `new_size == 0` (a special value for disabling memory limiting).
