...
* DBOptions::verify_sst_unique_id_in_manifest is now an on-by-default feature that verifies SST file identity as files are loaded naturally, rather than only at DB::Open.
