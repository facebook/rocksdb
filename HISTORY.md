...
* Fix a bug in GetOverlappingInputsRangeBinarySearch. If no files are found within or overlapping [begin, end), then this function should do `*next_smallest=nullptr`, indicating the smallest key of the file not chosen. Existing and previous code does not trigger this condition.
