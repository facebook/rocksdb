...
* Charge memory usage of file metadata created for newly added files to a Version. If such file metadata's memory exceeds the avaible space left in the block
