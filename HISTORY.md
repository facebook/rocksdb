...
* A new option, db_host_location, has been added to DBOptions. If left empty, this option defaults to the hostname (FQDN). Either the default or the user specified string is written to SST files as a table property
