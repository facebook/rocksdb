...
* Added value type to merge operation input and output that allows user to take value with different types and mutate value type through merge. Currently `kDeletion` is not supported as output type.
