...
struct DBOptions {
  ...
  // This provides the immutability that we except from snapshots. Moreover,
  // since Iterator and MultiGet internally depend on snapshots, the snapshot
  // immutability results into Iterator and MultiGet offering
  // consistent-point-in-time view.
  //
  // If true, although Read-Your-Own-Write property is still provided, the
  ...
  // visible to the snapshot after they are landed to the memtable. This
  // violates the immutability one expect from ::Get from a snapshot, as well as
  // ::MultiGet and Iterator's consistent-point-in-time view property.
  //
  // unordered_write=true trades higher write
