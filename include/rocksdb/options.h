...
struct IngestExternalFileOptions {
  ...
  // file is generated by a live DB with zero as the largest sequence number).
  // We only do limited sanity checking by checking the sequence numbers of the
  // largest and smallest keys of ingested files instead of scanning entire SST
  // files.
  // Warning: If a DB contains files ingested from a live DB, RepairDB()
  // may not correctly recover these files. They may not use the right global
  // sequence numbers, or they may be lost.
