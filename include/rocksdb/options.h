...
struct IngestExternalFileOptions {
  ...
  // Set to true if you would like to ingest SST files generated by live DB.
  // Notice: because SST files generated by live DB don't has global_seq table
  // property, so you must set write_global_seqno to false.
  bool ingest_live_db_files = false;
  // Set to false if you would like to ingest SST files with different CF ID
  // table property.
