...
struct IngestExternalFileOptions {
  ...
  // being ingested into.
  // Warning: If a DB contains files ingested from a live DB, RepairDB() may not
  // correctly recover these files. They may not use the right global sequence
  // numbers, or they may be lost.
