...
struct ReadOptions {
  ...
  // If DBOptions::rate_limiter is provided and rate_limit_verify_checksum =
  // true, this will be the priority level to charge the read IO in
  // Db::VerifyCheckSum to the rate limiter. Default: Env::IO_LOW
