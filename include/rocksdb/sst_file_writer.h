...
class SstFileWriter {
 public:
  // User can pass `column_family_id` to specify that the the generated file
  // will be ingested into column family with this id.
  SstFileWriter(
      const EnvOptions& env_options, const Options& options,
