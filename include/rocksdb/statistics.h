...
enum Tickers : uint32_t {
  ...
  // Number of compactions broken down by CompactionReason
  COMPACT_UNKNOWN_COUNT,
  ...
  COMPACT_FIFO_MAX_SIZE_COUNT,
  COMPACT_FIFO_REDUCE_NUM_FILES_COUNT,
  COMPACT_FIFO_TTL_COUNT,
  COMPACT_MANUAL_COUNT,
  COMPACT_FILES_MARKED_COUNT,
  COMPACT_BOTTOMMOST_FILES_COUNT,
  COMPACT_TTL_COUNT,
  COMPACT_FLUSH_COUNT,
  COMPACT_EXTERNAL_SST_INGESTION_COUNT,
  COMPACT_PERIODIC_COUNT,
  COMPACT_CHANGE_TEMPERATURE_COUNT,
  COMPACT_FORCED_BLOB_GC_COUNT,
  COMPACT_ROUND_ROBIN_TTL_COUNT,
  COMPACT_REFIT_LEVEL_COUNT,
