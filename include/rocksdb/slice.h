...
class Slice {
 public:
  ...
  // On failure due to invalid hex characters, *result may contain partially
  // decoded data; on failure due to null pointer or odd length, *result is
  // unchanged. This slice is expected to have an even number of 0-9A-F
  // characters, also accepts lowercase (a-f).
