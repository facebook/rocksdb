...
// The fields in this structure are EXPERIMENTAL and subject to change as the interface is refined.
...
// The CompactionService is EXPERIMENTAL and subject to change in a future release
class CompactionService : public Customizable {
 public:
  ...
  // indicate that the job should be terminated when the database is being shutdown.
  ...
  virtual std::vector<Status> DownloadFiles(const FileOptions& options,
