...
class UserDefinedIndexBuilder {
 public:
  ...
  // The table builder adds this to the estimated SST tail size, and
  // compaction asserts that the final tail does not exceed the last
  // estimate, so implementations must not under-report.
