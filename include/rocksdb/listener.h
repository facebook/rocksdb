...
class EventListener {
 public:
  ...
  // A callback function for RocksDB which will be called whenever a file rangeSync
  // operation finishes.
  virtual void onFileRangeSyncFinish(const FileOperationInfo& /* info */) {}

  // A callback function for RocksDB which will be called whenever a file truncate
  // operation finishes.
