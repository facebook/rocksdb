...
/* Copyright (c) 2011 The LevelDB Authors. All rights reserved.
  ...
  This is the generated public C API header for RocksDB. It is fully
  self-contained -- only standard C headers are included (<stdbool.h>,
  <stddef.h>, <stdint.h>), so consumers can parse it with no -I flags.

  To modify the C API:
    - Hand-written bindings: edit include/rocksdb/c_base.h
    - Auto-generated bindings: edit tools/c_api_gen/spec.json or
      tools/c_api_gen/auto_simple_bindings.py
      (do NOT edit c_api_gen/ or c.h -- overwritten on every regen)
  Then run: python3 tools/c_api_gen/regen_all.py

  Generated sections are wrapped with:
    // BEGIN generated: rocksdb/c_api_gen/<name>.h.inc
    ...
    // END generated: rocksdb/c_api_gen/<name>.h.inc
...
//     --source-out
//     db/c_api_gen/c_generated_db_simple_subset.cc.inc
...
//     --source-out
//     db/c_api_gen/c_generated_writebatch_subset.cc.inc
...
//     --source-out
//     db/c_api_gen/c_generated_block_based_options_subset.cc.inc
...
//     --source-out
//     db/c_api_gen/c_generated_jobinfo_metadata_subset.cc.inc
...
//     --source-out
//     db/c_api_gen/c_generated_cuckoo_options_subset.cc.inc
...
//     --source-out
//     db/c_api_gen/c_generated_transaction_subset.cc.inc
...
//     --source-out
//     db/c_api_gen/c_generated_transactiondb_subset.cc.inc
...
extern ROCKSDB_LIBRARY_API void
rocksdb_options_set_memtable_veirfy_per_key_checksum_on_seek(
    rocksdb_options_t* opt, unsigned char v);

extern ROCKSDB_LIBRARY_API unsigned char
rocksdb_options_get_memtable_veirfy_per_key_checksum_on_seek(
    rocksdb_options_t* opt);
...
extern ROCKSDB_LIBRARY_API void rocksdb_restore_options_set_keep_log_files(
    rocksdb_restore_options_t* opt, unsigned char v);
