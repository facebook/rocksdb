...
class Env {
 public:
  ...
  // If the 'search_path' is specified, breaks the path into its components based on
  // the appropriate platform separator (";" or ";") and looks for the library in those
  // directories.  If 'search path is not specified, uses the default library path search
