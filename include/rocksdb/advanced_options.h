...
struct AdvancedColumnFamilyOptions {
  ...
  // Check all the block checksums of output SST files generated by remote
  // worker for remote compactions before installing them.
  // This is a lighter check than paranoid_file_checks.
  //
  // Default: false
  //
  // Dynamically changeable through SetOptions() API
  bool remote_compaction_verify_block_checksums = false;
