...
class LDBTestCase(unittest.TestCase):
    ...
    def testIngestExternalSst(self):
        ...
        self.assertRunOK("batchput --db=%s --create_if_missing x1 y1 x2 y2 x3 y3 x4 y4" % dbPath, "OK")
        ...
        self.assertTrue(self.writeExternSst("--create_if_missing --db=%s"
            % dbPath, dumpFilePath, externSstPath))
        ...
        self.assertTrue(self.ingestExternSst("--create_if_missing --allow_global_seqno --db=%s"
            % dbPath, externSstPath))
        self.assertRunOKFull("scan --db=%s" % dbPath, "x1 : y10\nx2 : y20\nx3 : y30\nx4 : y40")
