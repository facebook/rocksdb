...
rm -rf ./testdb
./tools/test_delete --mode=grd --full_rtree=false --workload=test --ksize=128 --kvsize=512 --level_comp=10 --buffer_size=16 --rep_buffer_size=164 --max_key=20000000 --prep_num=1000000 --write_num=1000000 --read_num=1000000 --seek_num=0 --rdelete_num=100000 --rdelete_len=10 >> ./res/log.txt
rm -rf ./testdb
./tools/test_delete --mode=grd --full_rtree=true --workload=test --ksize=128 --kvsize=512 --level_comp=10 --buffer_size=16 --rep_buffer_size=164 --max_key=20000000 --prep_num=1000000 --write_num=1000000 --read_num=1000000 --seek_num=0 --rdelete_num=100000 --rdelete_len=10 >> ./res/log.txt