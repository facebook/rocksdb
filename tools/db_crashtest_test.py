...
class DBCrashTestTest(unittest.TestCase):
    ...
    def test_finalize_sanitizes_read_index_without_trie_factory(self):
        db_crashtest = self.load_db_crashtest()
        params = self.build_params(
            db_crashtest.default_params,
            {
        ...
        self.assertEqual(-1, finalized["read_index"])

    def test_finalize_sanitizes_builtin_read_index_for_custom_only(self):
        db_crashtest = self.load_db_crashtest()
        params = self.build_params(
            db_crashtest.default_params,
            {
    ...
    def test_finalize_keeps_builtin_read_index_for_custom_default(self):
        db_crashtest = self.load_db_crashtest()
        params = self.build_params(
            db_crashtest.default_params,
            {
