...
def _split_leading_comment_header(base: str) -> tuple[str, str]:
...
def _inline_fragments(
    ...
    if generated_banner is not None:
        header, rest = _split_leading_comment_header(base)
        base = header + generated_banner + rest.lstrip("\n")
