...
def _inline_fragments(
    ...
    copyright_marker = "//  Copyright (c) 2011-present"
    if base.startswith("// SOURCE TEMPLATE") and copyright_marker in base:
        base = base[base.index(copyright_marker):]
