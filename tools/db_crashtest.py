...
def finalize_and_sanitize(src_params):
    ...
    if (dest_params.get("test_batches_snapshots") == 1 or
        ...
        dest_params["ingest_external_file_one_in"] = 0
    # File ingestion does not guarantee prefix-recoverability when unsynced data
    # can be lost. Ingesting a file syncs data immediately that is newer than
    # unsynced memtable data that can be lost on restart.
    #
