...
class ThreadStatusUtil {
 ...
 protected:
  ...
  // in UnregisterThread().
  static photon::thread_local_ptr<bool, bool> thread_updater_initialized_;
  ...
  static photon::thread_local_ptr<ThreadStatusUpdater*, ThreadStatusUpdater*> thread_updater_local_cache_;
