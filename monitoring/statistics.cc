...
const std::vector<std::pair<Tickers, std::string>> TickersNameMap = {
    ...
    {WAL_PRECOMPRESS_BYTES, "rocksdb.wal.precompress.bytes"},
    {WAL_PRECOMPRESS_RECORDS, "rocksdb.wal.precompress.records"},
...
const std::vector<std::pair<Histograms, std::string>> HistogramsNameMap = {
    ...
    {WAL_PRECOMPRESS_MICROS, "rocksdb.wal.precompress.micros"},
    {WAL_PRECOMPRESS_GROUP_SIZE, "rocksdb.wal.precompress.group.size"},
