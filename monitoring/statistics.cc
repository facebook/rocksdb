...
const std::vector<std::pair<Tickers, std::string>> TickersNameMap = {
    ...
    {BLOB_DB_COMPRESSED_CACHE_MISS, "rocksdb.blobdb.compressed.cache.miss"},
    {BLOB_DB_COMPRESSED_CACHE_HIT, "rocksdb.blobdb.compressed.cache.hit"},
    {BLOB_DB_COMPRESSED_CACHE_ADD, "rocksdb.blobdb.compressed.cache.add"},
    {BLOB_DB_COMPRESSED_CACHE_ADD_FAILURES,
     "rocksdb.blobdb.compressed.cache.add.failures"},
    {BLOB_DB_COMPRESSED_CACHE_BYTES_READ,
     "rocksdb.blobdb.compressed.cache.bytes.read"},
    {BLOB_DB_COMPRESSED_CACHE_BYTES_WRITE,
     "rocksdb.blobdb.compressed.cache.bytes.write"},
