...
const std::vector<std::pair<Tickers, std::string>> TickersNameMap = {
    ...
    {COMPACT_READ_BYTES_DELETE_TRIGGERED,
     "rocksdb.compact.read.delete_triggered.bytes"},
    {COMPACT_READ_BYTES_PERIODIC, "rocksdb.compact.read.periodic.bytes"},
    {COMPACT_READ_BYTES_TTL, "rocksdb.compact.read.ttl.bytes"},
    {COMPACT_WRITE_BYTES_DELETE_TRIGGERED,
     "rocksdb.compact.write.delete_triggered.bytes"},
