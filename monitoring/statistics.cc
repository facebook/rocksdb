...
const std::vector<std::pair<Tickers, std::string>> TickersNameMap = {
    ...
    {COMPACT_UNKNOWN_COUNT, "rocksdb.compact.unknown.count"},
    {COMPACT_LEVEL_L0_FILES_NUM_COUNT,
     "rocksdb.compact.level.l0.files.num.count"},
    {COMPACT_LEVEL_MAX_LEVEL_SIZE_COUNT,
     "rocksdb.compact.level.max.level.size.count"},
    {COMPACT_UNIVERSAL_SIZE_AMPLIFICATION_COUNT,
     "rocksdb.compact.universal.size.amplification.count"},
    {COMPACT_UNIVERSAL_SIZE_RATIO_COUNT,
     "rocksdb.compact.universal.size.ratio.count"},
    {COMPACT_UNIVERSAL_SORTED_RUN_NUM_COUNT,
     "rocksdb.compact.universal.sorted.run.num.count"},
    {COMPACT_FIFO_MAX_SIZE_COUNT, "rocksdb.compact.fifo.max.size.count"},
    {COMPACT_FIFO_REDUCE_NUM_FILES_COUNT,
     "rocksdb.compact.fifo.reduce.num.files.count"},
    {COMPACT_FIFO_TTL_COUNT, "rocksdb.compact.fifo.ttl.count"},
    {COMPACT_MANUAL_COUNT, "rocksdb.compact.manual.count"},
    {COMPACT_FILES_MARKED_COUNT, "rocksdb.compact.files.marked.count"},
    {COMPACT_BOTTOMMOST_FILES_COUNT, "rocksdb.compact.bottommost.files.count"},
    {COMPACT_TTL_COUNT, "rocksdb.compact.ttl.count"},
    {COMPACT_FLUSH_COUNT, "rocksdb.compact.flush.count"},
    {COMPACT_EXTERNAL_SST_INGESTION_COUNT,
     "rocksdb.compact.external.sst.ingestion.count"},
    {COMPACT_PERIODIC_COUNT, "rocksdb.compact.periodic.count"},
    {COMPACT_CHANGE_TEMPERATURE_COUNT,
     "rocksdb.compact.change.temperature.count"},
    {COMPACT_FORCED_BLOB_GC_COUNT, "rocksdb.compact.forced.blob.gc.count"},
    {COMPACT_ROUND_ROBIN_TTL_COUNT, "rocksdb.compact.round.robin.ttl.count"},
    {COMPACT_REFIT_LEVEL_COUNT, "rocksdb.compact.refit.level.count"},
};
