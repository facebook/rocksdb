...
BlockBuilder::BlockBuilder(
    int block_restart_interval, size_t ts_sz,
    bool persist_user_defined_timestamps, bool is_user_key,
    bool use_delta_encoding, bool use_value_delta_encoding,
