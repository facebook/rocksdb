 ...
 public:
  ...
  PartitionedFilterBlockTest() : bits_per_key_(10) {
    ...
    if (test::IsUDTEnabled(udt_test_mode)) {
      ...
      options_.persist_user_defined_timestamps =
          test::ShouldPersistUDT(udt_test_mode);
    }
  ...
  PartitionedIndexBuilder* NewIndexBuilder() {
    ...
    return PartitionedIndexBuilder::CreateIndexBuilder(
        &icomp_, ioptions_.persist_user_defined_timestamps, !kValueDeltaEncoded,
        table_options_);
  }
  ...
  PartitionedFilterBlockBuilder* NewBuilder(
    ...
    return new PartitionedFilterBlockBuilder(
        ...
        table_options_.index_block_restart_interval, ts_sz_,
        ioptions_.persist_user_defined_timestamps, !kValueDeltaEncoded,
