...
PartitionedFilterBlockBuilder::PartitionedFilterBlockBuilder(
    ...
    : FullFilterBlockBuilder(_prefix_extractor, whole_key_filtering,
      ...
      partitioned_index_builder_(partitioned_index_builder),
      ts_sz_(ts_sz),
...
void PartitionedFilterBlockBuilder::RequestPartitionCut() {
  if (LIKELY(partitioned_index_builder_ != nullptr)) {
...
const std::string& PartitionedFilterBlockBuilder::GetPartitionKey() {
  ...
  return partition_coordinator_->GetPartitionKey();
}
...
bool PartitionedFilterBlockBuilder::IndexSeparatorIsKeyPlusSeq() {
  ...
  return partition_coordinator_->separator_is_key_plus_seq();
}
