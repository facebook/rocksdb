...
TEST_P(BlockTest, SimpleTest) {
  ...
  BlockBuilder builder(16, keyUseDeltaEncoding(), false /* use_value_delta_encoding */, BlockBasedTableOptions::kDataBlockBinarySearch,
  ...
  InternalIterator *iter = reader.NewDataIterator(
      ...
      nullptr /* iter */,
      nullptr /* stats */, false /* block_contents_pinned */, options.persist_user_defined_timestamps);
...
BlockContents GetBlockContents(std::unique_ptr<BlockBuilder> *builder,
  ...
  builder->reset(new BlockBuilder(1 /* restart interval */,
                                  key_use_delta_encoding, false /* use_value_delta_encoding */, BlockBasedTableOptions::kDataBlockBinarySearch,
                                  0.75 /* data_block_hash_table_util_ratio */,  ts_sz,
...
void CheckBlockContents(BlockContents contents, const int max_key,
  ...
  std::unique_ptr<InternalIterator> regular_iter(reader2.NewDataIterator(
      is_udt_enabled ? test::BytewiseComparatorWithU64TsWrapper()
                     : BytewiseComparator(),
      kDisableGlobalSequenceNumber, nullptr /* iter */,
      nullptr /* stats */, false /* block_contents_pinned */, should_persist_udt));
...
TEST_P(IndexBlockTest, IndexValueEncodingTest) {
  ...
  BlockBuilder builder(16,
                       kUseDeltaEncoding, useValueDeltaEncoding(),BlockBasedTableOptions::kDataBlockBinarySearch,
                       0.75 /* data_block_hash_table_util_ratio */,  ts_sz, shouldPersistUDT(), !keyIncludesSeq());
  ...
  InternalIteratorBase<IndexValue> *iter = reader.NewIndexIterator(
      ...
      kTotalOrderSeek, includeFirstKey(), keyIncludesSeq(), !useValueDeltaEncoding(),
