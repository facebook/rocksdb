...
void BlockBasedTableIterator::Prepare(const MultiScanOptions* scan_opts) {
  ...
  //     // Scan range is specified in user key, here we seek to the minimum
  //     internal
  ...
  //     block_ranges_per_scan.emplace_back(blocks_to_prepare.size() -
  //     num_blocks,
  ...
  //         const auto block_offset_in_buffer = block.offset() -
  //         read_req.offset;
  ...
  //   // Successful Prepare, init related states so the iterator reads from
  //   prepared
  //   // blocks
