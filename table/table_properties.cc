...
std::string TableProperties::ToString(
  ...
  snprintf(index_block_size_str, sizeof(index_block_size_str),
           "index block size (with-seq# %d)",
           static_cast<int>(index_key_includes_seq));
...
void TableProperties::Add(const TableProperties& tp) {
  ...
  index_key_includes_seq += tp.index_key_includes_seq;
...
const std::string TablePropertiesNames::kIndexKeyIncludesSeq =
    "rocksdb.index.key.includes.seq";
