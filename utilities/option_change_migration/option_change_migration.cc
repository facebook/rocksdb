...
Status MigrateToUniversal(const std::string& dbname, const Options& old_opts,
...
Status MigrateToLevelBase(const std::string& dbname, const Options& old_opts,
                          const Options& new_opts) {
...
#else
namespace ROCKSDB_NAMESPACE {
Status OptionChangeMigration(const std::string& /*dbname*/,
