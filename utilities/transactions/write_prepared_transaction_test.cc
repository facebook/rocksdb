...
class WritePreparedTransactionTestBase : public TransactionTestBase {
 public:
  WritePreparedTransactionTestBase(bool use_stackable_db, bool two_write_queue,
      ...
      : TransactionTestBase(use_stackable_db, two_write_queue,
                            user_per_key_point_lock_mgr, write_policy,
                            write_ordering){};
...
class SnapshotConcurrentAccessTest
    : public WritePreparedTransactionTestBase,
      virtual public ::testing::WithParamInterface<std::tuple<
          bool, bool, bool, TxnDBWritePolicy, WriteOrdering, size_t, size_t>> {
 public:
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kOrderedWrite, 0, 20),
                      ...
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 0, 20),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 1, 20),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 2, 20),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 3, 20),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 4, 20),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 5, 20),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 6, 20),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 7, 20),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 8, 20),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 9, 20),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 10, 20),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 11, 20),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 12, 20),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 13, 20),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 14, 20),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 15, 20),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 16, 20),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 17, 20),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 18, 20),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 19, 20)));
INSTANTIATE_TEST_CASE_P(
    TwoWriteQueuesPerKeyPointLockManager, SnapshotConcurrentAccessTest,
    ::testing::Values(std::make_tuple(false, true, true, WRITE_PREPARED,
                                      kOrderedWrite, 0, 20),
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(std::make_tuple(false, false, false, WRITE_PREPARED,
                                      kOrderedWrite, 0, 20),
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(std::make_tuple(false, true, false, WRITE_PREPARED,
                      ...
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kOrderedWrite, 9, 10),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 0, 10),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 1, 10),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 2, 10),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 3, 10),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 4, 10),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 5, 10),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 6, 10),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 7, 10),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 8, 10),
                      std::make_tuple(false, true, false, WRITE_PREPARED,
                                      kUnorderedWrite, 9, 10),
