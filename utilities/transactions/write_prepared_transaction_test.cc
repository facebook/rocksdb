...
class WritePreparedTransactionTestBase : public TransactionTestBase {
 public:
  WritePreparedTransactionTestBase(bool use_stackable_db, bool two_write_queue,
      ...
      : TransactionTestBase(use_stackable_db, two_write_queue, write_policy, write_ordering){};
...
class SnapshotConcurrentAccessTest
    : public WritePreparedTransactionTestBase,
      virtual public ::testing::WithParamInterface<
          std::tuple<bool, bool, TxnDBWritePolicy, WriteOrdering, size_t, size_t>> {
 public:
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(
                      ...
                      std::make_tuple(false, false, WRITE_PREPARED, kUnorderedWrite, 19, 20)
));
