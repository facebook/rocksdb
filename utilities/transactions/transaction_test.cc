...
TEST_P(TransactionTest, WaitingTxn) {
  ...
  ASSERT_OK(s);
  TransactionOptions txn_options_with_enable_get_waiting_txn_after_timeout =
      txn_options;
  txn_options_with_enable_get_waiting_txn_after_timeout
      .enable_get_waiting_txn_after_timeout = true;

  Transaction* txn1 = db->BeginTransaction(write_options, txn_options);
  Transaction* txn2 = db->BeginTransaction(write_options, txn_options);
  Transaction* txn3 = db->BeginTransaction(
      write_options, txn_options_with_enable_get_waiting_txn_after_timeout);
