...
TEST_F(PatternEntryTest, MatchOldRegex) {
  // Matches A:.*
  std::unique_ptr<ObjectLibrary::PatternEntry> entry(
      new ObjectLibrary::PatternEntry("A:.*"));
  ...
  // Matches A:.+
  entry.reset(new ObjectLibrary::PatternEntry("A:.+"));
  ASSERT_FALSE(entry->Matches("A"));
  ASSERT_FALSE(entry->Matches("AA"));
  ASSERT_FALSE(entry->Matches("AB"));
  ASSERT_FALSE(entry->Matches("B"));
  ...
  ASSERT_TRUE(entry->Matches("AB"));
  ASSERT_FALSE(entry->Matches("B"));
  ASSERT_TRUE(entry->Matches("A:"));
  ASSERT_FALSE(entry->Matches("B:"));
  ASSERT_FALSE(entry->Matches("B:A"));
  ASSERT_TRUE(entry->Matches("AA:"));
  ASSERT_TRUE(entry->Matches("AA:B"));
  ASSERT_TRUE(entry->Matches("AA:BB"));
  ASSERT_TRUE(entry->Matches("A:B"));
  ASSERT_TRUE(entry->Matches("A:BB"));
}
