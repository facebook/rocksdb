...
class BlobIndexCompactionFilterBase : public CompactionFilter {
 public:
  ...
  void SetUserCompactionFilter(const CompactionFilter* user_filter);
  void SetUserCompactionFilter(std::unique_ptr<CompactionFilter>* user_filter);

 protected:
  Statistics* statistics() const { return statistics_; }
  const CompactionFilter* user_data_filter() const { return user_filter_; }
 ...
 private:
  ...
  const CompactionFilter* user_filter_;
  // Lifespan of user_filter_, if it's generated by CompactionFilterFactory.
  std::unique_ptr<CompactionFilter> user_filter_ptr_;
...
class BlobIndexCompactionFilterFactoryBase : public CompactionFilterFactory {
 public:
  BlobIndexCompactionFilterFactoryBase(BlobDBImpl* _blob_db_impl, Env* _env,
      ...
      : user_filter_(_cf_options.compaction_filter),
        user_filter_factory_(_cf_options.compaction_filter_factory),
 ...
 protected:
  const CompactionFilter* user_filter_;
  std::shared_ptr<CompactionFilterFactory> user_filter_factory_;
