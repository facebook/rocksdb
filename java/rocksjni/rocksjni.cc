...
jlongArray Java_org_rocksdb_RocksDB_getReferenceCounts(JNIEnv* env, jobject,
  ...
  std::unique_ptr<APIRocksDB<ROCKSDB_NAMESPACE::DB>> dbAPI(
      reinterpret_cast<APIRocksDB<ROCKSDB_NAMESPACE::DB>*>(jhandle));
  std::vector<long> counts = dbAPI->use_counts();
  return APIBase::longArrayFromVector(env, counts);
}
 ...
 * exception occurs
 */
jobjectArray multi_get_helper(JNIEnv* env, jobject,
                              APIRocksDB<ROCKSDB_NAMESPACE::DB>& dbAPI,
 ...
 */
void multi_get_helper_direct(JNIEnv* env, jobject,
                             APIRocksDB<ROCKSDB_NAMESPACE::DB>& dbAPI,
                             const ROCKSDB_NAMESPACE::ReadOptions& rOpt,
                             jlongArray jcolumn_family_handles,
...
jobjectArray Java_org_rocksdb_RocksDB_multiGet__J_3_3B_3I_3I_3J(
  ...
  return multi_get_helper(
      env, jdb,
      *reinterpret_cast<APIRocksDB<ROCKSDB_NAMESPACE::DB>*>(jdb_handle),
      ROCKSDB_NAMESPACE::ReadOptions(), jkeys, jkey_offs, jkey_lens,
