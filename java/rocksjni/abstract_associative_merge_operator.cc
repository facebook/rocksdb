...
using namespace rocksdb;
 ...
 void  Java_org_rocksdb_AbstractAssociativeMergeOperator_initJavaAbstractAssociativeMergeOperator(
...
jlong Java_org_rocksdb_AbstractAssociativeMergeOperator_newJavaAbstractAssociativeMergeOperator(
