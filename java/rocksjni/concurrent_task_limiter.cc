 ...
 */
jstring Java_org_rocksdb_limiter_ConcurrentTaskLimiterImpl_name
  (JNIEnv *env, jclass, jlong handle) {
  const auto& limiter =
      *reinterpret_cast<std::shared_ptr<ROCKSDB_NAMESPACE::ConcurrentTaskLimiter>*>(handle);
 ...
 * Signature: (JI)V
 */
void Java_org_rocksdb_limiter_ConcurrentTaskLimiterImpl_setMaxOutstandingTask
 ...
 * Signature: (J)V
 */
void Java_org_rocksdb_limiter_ConcurrentTaskLimiterImpl_resetMaxOutstandingTask
 ...
 * Signature: (J)I
 */
jint Java_org_rocksdb_limiter_ConcurrentTaskLimiterImpl_outstandingTask
  (JNIEnv *, jclass, jlong handle) {
  const auto& limiter =
      *reinterpret_cast<std::shared_ptr<ROCKSDB_NAMESPACE::ConcurrentTaskLimiter>*>(handle);
