 ...
 */
jlong Java_org_rocksdb_util_StdErrLogger_newStdErrLogger(JNIEnv* env, jclass /*jcls*/, jbyte jlog_level, jstring jlog_prefix) {
 ...
 * Signature: (JB)V
 */
void Java_org_rocksdb_util_StdErrLogger_setInfoLogLevel(JNIEnv* /*env*/, jclass /*jcls*/, jlong jhandle, jbyte jlog_level) {
  auto* handle =
 ...
 * Signature: (J)B
 */
jbyte Java_org_rocksdb_util_StdErrLogger_infoLogLevel(JNIEnv* /*env*/, jclass /*jcls*/, jlong jhandle) {
  auto* handle =
      reinterpret_cast<std::shared_ptr<ROCKSDB_NAMESPACE::StderrLogger>*>(
          jhandle);
 ...
 * Signature: (J)V
 */
void Java_org_rocksdb_util_StdErrLogger_disposeInternal(JNIEnv* /*env*/, jobject /*jobj*/, jlong jhandle) {
  auto* handle =
      reinterpret_cast<std::shared_ptr<ROCKSDB_NAMESPACE::StderrLogger>*>(
          jhandle);
