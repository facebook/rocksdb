...
jlong Java_org_rocksdb_BlockBasedTableConfig_newTableFactoryHandle(
  ...
  options.optimize_filters_for_memory = static_cast<bool>(joptimize_filters_for_memory);
  ...
  options.index_shortening = ROCKSDB_NAMESPACE::IndexShorteningModeJni::toCppIndexShorteningMode(
      jindex_shortening);
