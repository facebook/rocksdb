...
public class ColumnFamilyDescriptorTest {
    ...
    public void newInstance() throws RocksDBException {
        try(ColumnFamilyDescriptor cf_descriptor = new ColumnFamilyDescriptor("new_CF".getBytes(StandardCharsets.UTF_8))) {
    ...
    public void fromHandle2Descriptor() throws RocksDBException {
        ...
        try (final RocksDB db =
            ...
            ColumnFamilyDescriptor result = cfHandle.getDescriptor(); // This creates new ColumnFamilyDescriptor in JNI code.
                                                                      ...
                                                                      //   C++ allocation and ColumnFamilyDescriptor must free this memory.
            ...
            assertThat(cfOptions.isOwningHandle()).isFalse();   // close underlying cfOptions even when instance is created in JNI code.
        }
