...
public class SstFileMetaDataTest {
  ...
  @Test
  public void createSstFileMetaDataWithParameters() throws UnsupportedEncodingException {
    ...
    try (final SstFileMetaData metadata =
             new SstFileMetaData(fileName, path, size, smallestSeqno, largestSeqno, smallestKey,
