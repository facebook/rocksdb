...
public class SecondaryDBTest {
  ...
  @Rule
  public TemporaryFolder secondaryDbFolder = new TemporaryFolder();
  ...
  public void openAsSecondary() throws RocksDBException {
    try (final Options options = new Options()
      ...
      try (final Options secondaryOptions = new Options();
          final RocksDB secondaryDb = RocksDB.openAsSecondary(
          secondaryOptions,
          dbFolder.getRoot().getAbsolutePath(),
          secondaryDbFolder.getRoot().getAbsolutePath())) {

        assertThat(secondaryDb.get("key1".getBytes()))
            .isEqualTo("value1".getBytes());
        assertThat(secondaryDb.get("key2".getBytes()))
            .isEqualTo("value2".getBytes());
        assertThat(secondaryDb.get("key3".getBytes()))
        ...
        // check secondary
        assertThat(secondaryDb.get("key4".getBytes()))
            .isEqualTo("value4".getBytes());
        assertThat(secondaryDb.get("key5".getBytes()))
            .isEqualTo("value5".getBytes());
        assertThat(secondaryDb.get("key6".getBytes()))
        ...
        try {
          ...
          try (final DBOptions secondaryOptions = new DBOptions();
            ...
            try {
              ...
              for (final ColumnFamilyHandle secondaryCfHandle :
                  secondaryCfHandles) {
