...
public class BlockBasedTableConfigTest {
  ...
  public void cacheIndexAndFilterBlocksWithHighPriority() {
    ...
    assertThat(blockBasedTableConfig.cacheIndexAndFilterBlocksWithHighPriority()).isTrue();
  }
  ...
  public void pinL0FilterAndIndexBlocksInCache() {
    ...
    assertThat(blockBasedTableConfig.pinL0FilterAndIndexBlocksInCache()).isTrue();
  }
  ...
  public void pinTopLevelIndexAndFilter() {
    ...
    assertThat(blockBasedTableConfig.pinTopLevelIndexAndFilter()).isFalse();
  }
  ...
  public void checksumType() {
    ...
    assertThat(ChecksumType.valueOf("kxxHash")).isEqualTo(ChecksumType.kxxHash);
    blockBasedTableConfig.setChecksumType(ChecksumType.kNoChecksum);
    blockBasedTableConfig.setChecksumType(ChecksumType.kxxHash);
    assertThat(blockBasedTableConfig.checksumType().equals(ChecksumType.kxxHash));
  }
  ...
  public void blockCache() {
    try (final Cache cache = new LRUCache(17 * 1024 * 1024);
         final Options options =
             new Options().setTableFormatConfig(new BlockBasedTableConfig().setBlockCache(cache))) {
  ...
  public void persistentCache() throws RocksDBException {
    try (final DBOptions dbOptions =
      ...
      try (final PersistentCache persistentCache = new PersistentCache(
               Env.getDefault(), dbFolder.getRoot().getPath(), 1024 * 1024 * 100, logger, false);
      ...
      try (final Options options = new Options()
        ...
        for (int shard = 0; shard < 8; shard++) {
          try (final FlushOptions flushOptions = new FlushOptions();
            ...
            assertThat(statistics.getTickerCount(TickerType.BLOCK_CACHE_COMPRESSED_ADD))
                .isEqualTo(shard + 1);
          }
        }
      }
  ...
  public void blockSizeDeviation() {
    ...
    assertThat(blockBasedTableConfig.blockSizeDeviation()).isEqualTo(12);
  }
  ...
  public void blockRestartInterval() {
    ...
    assertThat(blockBasedTableConfig.blockRestartInterval()).isEqualTo(15);
  }
  ...
  public void indexBlockRestartInterval() {
    ...
    assertThat(blockBasedTableConfig.indexBlockRestartInterval()).isEqualTo(15);
  }
  ...
  public void metadataBlockSize() {
    ...
    assertThat(blockBasedTableConfig.metadataBlockSize()).isEqualTo(1024);
  }
  ...
  public void partitionFilters() {
    ...
    assertThat(blockBasedTableConfig.partitionFilters()).isTrue();
  }
  ...
  public void useDeltaEncoding() {
    ...
    assertThat(blockBasedTableConfig.useDeltaEncoding()).isFalse();
  }
  ...
  public void wholeKeyFiltering() {
    ...
    assertThat(blockBasedTableConfig.wholeKeyFiltering()).isFalse();
  }
  ...
  public void verifyCompression() {
    ...
    assertThat(blockBasedTableConfig.verifyCompression()).isTrue();
  }
  ...
  public void readAmpBytesPerBit() {
    ...
    assertThat(blockBasedTableConfig.readAmpBytesPerBit()).isEqualTo(2);
  }
  ...
  public void enableIndexCompression() {
    ...
    assertThat(blockBasedTableConfig.enableIndexCompression()).isFalse();
  }
  ...
  public void blockAlign() {
    ...
    assertThat(blockBasedTableConfig.blockAlign()).isTrue();
  }
  ...
  public void blockCacheSize() {
    ...
    assertThat(blockBasedTableConfig.blockCacheSize()).isEqualTo(8 * 1024);
  }
  ...
  public void blockCacheNumShardBits() {
    ...
    assertThat(blockBasedTableConfig.cacheNumShardBits()).isEqualTo(5);
  }
  ...
  public void blockCacheCompressedSize() {
    ...
    assertThat(blockBasedTableConfig.blockCacheCompressedSize()).isEqualTo(40);
  }
  ...
  public void blockCacheCompressedNumShardBits() {
    ...
    assertThat(blockBasedTableConfig.blockCacheCompressedNumShardBits()).isEqualTo(4);
  }
}
