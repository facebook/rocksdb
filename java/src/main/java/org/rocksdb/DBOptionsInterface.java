...
public interface DBOptionsInterface {
   ...
   */
  DBOptionsInterface setEnv(final Env env);
   ...
   * @return the instance of the current Options
   */
  DBOptionsInterface setIncreaseParallelism(int totalThreads);
   ...
   */
  DBOptionsInterface setCreateIfMissing(boolean flag);
   ...
   *     on open.
   */
  DBOptionsInterface setCreateMissingColumnFamilies(boolean flag);
   ...
   * @see RocksDB#open(org.rocksdb.Options, String)
   */
  DBOptionsInterface setErrorIfExists(boolean errorIfExists);
   ...
   * @return the reference to the current option.
   */
  DBOptionsInterface setParanoidChecks(boolean paranoidChecks);
   ...
   * @since 3.10.0
   */
  DBOptionsInterface setRateLimiter(RateLimiter rateLimiter);
   ...
   * @return the instance of the current object.
   */
  DBOptionsInterface setInfoLogLevel(InfoLogLevel infoLogLevel);
   ...
   * @return the instance of the current object.
   */
  DBOptionsInterface setMaxOpenFiles(int maxOpenFiles);
   ...
   * @return the instance of the current object.
   */
  DBOptionsInterface setMaxTotalWalSize(long maxTotalWalSize);
   ...
   * @return the instance of the current object.
   */
  DBOptionsInterface setUseFsync(boolean useFsync);
   ...
   * @return the instance of the current object.
   */
  DBOptionsInterface setDbLogDir(String dbLogDir);
   ...
   * @return the instance of the current object.
   */
  DBOptionsInterface setWalDir(String walDir);
   ...
   * @return the instance of the current object.
   */
  DBOptionsInterface setDeleteObsoleteFilesPeriodMicros(long micros);
   ...
   */
  DBOptionsInterface setMaxBackgroundCompactions(int maxBackgroundCompactions);
   ...
   */
  DBOptionsInterface setMaxBackgroundFlushes(int maxBackgroundFlushes);
   ...
   */
  DBOptionsInterface setMaxLogFileSize(long maxLogFileSize);
   ...
   *   while overflowing the underlying platform specific value.
   */
  DBOptionsInterface setLogFileTimeToRoll(long logFileTimeToRoll);
   ...
   *   while overflowing the underlying platform specific value.
   */
  DBOptionsInterface setKeepLogFileNum(long keepLogFileNum);
   ...
   * @return the instance of the current object.
   */
  DBOptionsInterface setMaxManifestFileSize(long maxManifestFileSize);
   ...
   * @return the instance of the current object.
   */
  DBOptionsInterface setTableCacheNumshardbits(int tableCacheNumshardbits);
   ...
   */
  DBOptionsInterface setWalTtlSeconds(long walTtlSeconds);
   ...
   * @see #setWalSizeLimitMB(long)
   */
  DBOptionsInterface setWalSizeLimitMB(long sizeLimitMB);
   ...
   *   while overflowing the underlying platform specific value.
   */
  DBOptionsInterface setManifestPreallocationSize(long size);
   ...
   * @return the instance of the current object.
   */
  DBOptionsInterface setUseDirectReads(boolean useDirectReads);
   ...
   * @return the instance of the current object.
   */
  DBOptionsInterface setUseDirectWrites(boolean useDirectWrites);
   ...
   * @return the instance of the current object.
   */
  DBOptionsInterface setAllowMmapReads(boolean allowMmapReads);
   ...
   * @return the instance of the current object.
   */
  DBOptionsInterface setAllowMmapWrites(boolean allowMmapWrites);
   ...
   * @return the instance of the current object.
   */
  DBOptionsInterface setIsFdCloseOnExec(boolean isFdCloseOnExec);
   ...
   * @return the instance of the current object.
   */
  DBOptionsInterface setStatsDumpPeriodSec(int statsDumpPeriodSec);
   ...
   * @return the instance of the current object.
   */
  DBOptionsInterface setAdviseRandomOnOpen(boolean adviseRandomOnOpen);
   ...
   * @return the instance of the current object.
   */
  DBOptionsInterface setUseAdaptiveMutex(boolean useAdaptiveMutex);
   ...
   * @return the instance of the current object.
   */
  DBOptionsInterface setBytesPerSync(long bytesPerSync);
