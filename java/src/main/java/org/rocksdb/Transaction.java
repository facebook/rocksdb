...
public class Transaction extends RocksObject {
  ...
  */
  ...
  public WaitingTransactions getWaitingTxns() {
    assert(isOwningHandle());
    return getWaitingTxns(nativeHandle_, parent.nativeHandle_);
  }
  ...
  /**
   * Called from C++ native method {@link #getWaitingTxns(long, long)}
  ...
  private WaitingTransactions newWaitingTransactions(
      final long columnFamilyHandle, final String key,
      final long[] transactionIds) {
    return new WaitingTransactions(parent, columnFamilyHandle, key, transactionIds);
  }
  ...
  public static class WaitingTransactions {
    ...
    private WaitingTransactions(final RocksDB parent,
        final long columnFamilyHandle, final String key,
        final long[] transactionIds) {
