...
public class IngestExternalFileOptions extends RocksObject {
  ...
  /**
   * Returns true if files generated by a live DB, instead of SstFileWriter,
   * are allowed to be ingested.
   *
   * @return true if DB generated files are allowed, false otherwise.
   */
  public boolean allowDbGeneratedFiles() {
    return allowDbGeneratedFiles(nativeHandle_);
  }

  /**
   * Set to true to allow ingestion of files generated by a live DB, instead
   * of SstFileWriter. When true, original sequence numbers are preserved and
   * ingested files must not overlap with existing data in the DB.
   *
   * @param allowDbGeneratedFiles true if DB generated files are allowed
   *
   * @return the reference to the current IngestExternalFileOptions.
   */
  public IngestExternalFileOptions setAllowDbGeneratedFiles(
      final boolean allowDbGeneratedFiles) {
    setAllowDbGeneratedFiles(nativeHandle_, allowDbGeneratedFiles);
    return this;
  }
  ...
  private static native boolean allowDbGeneratedFiles(final long handle);
  private static native void setAllowDbGeneratedFiles(
      final long handle, final boolean allowDbGeneratedFiles);
}
