...
public class RateLimiter extends RocksObject {
  ...
  public RateLimiter(final long rateBytesPerSecond,
    ...
    fairness_ = fairness;
    nativeHandle_ = newRateLimiterHandle(rateBytesPerSecond,
  ...
  private static native long newRateLimiterHandle(
      long rateBytesPerSecond, long refillPeriodMicros, int fairness);

  private native void disposeInternal(long handle);
  private native void setBytesPerSecond(long handle, long bytesPerSecond);
  private native void request(long handle, long bytes);
  private native long getSingleBurstBytes(long handle);
  private native long getTotalBytesThrough(long handle);
  private native long getTotalRequests(long handle);
