...
```bash
$ mvn install:install-file -Dfile=./java/target/rocksdbjni-6.26.0-osx.jar -DgroupId=org.rocksdb -DartifactId=rocksdbjni -Dversion=6.26.0-SNAPSHOT -Dpackaging=jar
```
