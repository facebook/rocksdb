...
TEST_F(VersionEditTest, EncodeDecode) {
  ...
  for (int i = 0; i < 4; i++) {
    ...
    edit.AddFile(3, kBig + 300 + i, kBig32Bit + 400 + i, 0,
                 ...
                 kInvalidBlobFileNumber, 888, 678, kUnknownL0EpochNumber, "234",
...
TEST_F(VersionEditTest, EncodeDecodeNewFile4) {
  ...
  edit.AddFile(5, 302, 0, 100, InternalKey("foo", kBig + 502, kTypeValue),
               ...
               666, 888, kUnknownL0EpochNumber, kUnknownFileChecksum,
               kUnknownFileChecksumFuncName, kNullUniqueId64x2);
...
TEST_F(VersionEditTest, ForwardCompatibleNewFile4) {
  ...
  edit.AddFile(4, 301, 3, 100, InternalKey("foo", kBig + 501, kTypeValue),
               InternalKey("zoo", kBig + 601, kTypeDeletion), kBig + 501,
               kBig + 601, false, Temperature::kUnknown, kInvalidBlobFileNumber,
               686, 868, kUnknownL0EpochNumber, "234", "crc32c",
               kNullUniqueId64x2);
  edit.DeleteFile(4, 700);
...
TEST_F(VersionEditTest, EncodeEmptyFile) {
  ...
  edit.AddFile(0, 0, 0, 0, InternalKey(), InternalKey(), 0, 0, false,
               ...
               kUnknownOldestAncesterTime, kUnknownFileCreationTime,
               1 /*l0_epoch_number*/, kUnknownFileChecksum,
               kUnknownFileChecksumFuncName, kNullUniqueId64x2);
  std::string buffer;
