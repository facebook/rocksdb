...
TEST_F(DBIteratorTest, DBIteratorPrevNext) {
  ...
  MutableCFOptions mutable_cf_options = MutableCFOptions(options);
  {
    ...
    std::unique_ptr<Iterator> db_iter(NewDBIterator(
        ...
        internal_iter, nullptr /* version */, 10,
...

  {
    ...
    std::unique_ptr<Iterator> db_iter(NewDBIterator(
        env_, ro, cf_options, mutable_cf_options, BytewiseComparator(),
        internal_iter, nullptr /* version */, 7,
        options.max_sequential_skip_in_iterations, nullptr /*read_callback*/));
  ...
  // and less that the iterator's sequence id)
  {
    ...
    std::unique_ptr<Iterator> db_iter(NewDBIterator(
        env_, ro, cf_options, mutable_cf_options, BytewiseComparator(),
        internal_iter, nullptr /* version */, 4,
        options.max_sequential_skip_in_iterations, nullptr /*read_callback*/));
...

  {
    ...
    std::unique_ptr<Iterator> db_iter(NewDBIterator(
        env_, ro, cf_options, mutable_cf_options, BytewiseComparator(),
        internal_iter, nullptr /* version */, 2,
        options.max_sequential_skip_in_iterations, nullptr /*read_callback*/));
    db_iter->SeekToLast();
    ASSERT_TRUE(db_iter->Valid());
    ASSERT_EQ(db_iter->key().ToString(), "b");
...
TEST_F(DBIteratorTest, DBIteratorEmpty) {
...

  {
    ...
    std::unique_ptr<Iterator> db_iter(NewDBIterator(
        env_, ro, cf_options, mutable_cf_options, BytewiseComparator(),
        internal_iter, nullptr /* version */, 0,
        options.max_sequential_skip_in_iterations, nullptr /*read_callback*/));
    db_iter->SeekToLast();
    ASSERT_TRUE(!db_iter->Valid());
  }
...
TEST_F(DBIteratorTest, DBIteratorUseSkipCountSkips) {
  ...
  std::unique_ptr<Iterator> db_iter(NewDBIterator(
      ...
      BytewiseComparator(), internal_iter, nullptr /* version */, 2,
      options.max_sequential_skip_in_iterations, nullptr /*read_callback*/));
  db_iter->SeekToLast();
  ASSERT_TRUE(db_iter->Valid());
  ASSERT_EQ(db_iter->key().ToString(), "c");
...
TEST_F(DBIteratorTest, DBIteratorUseSkip) {
...

  {
    for (size_t i = 0; i < 200; ++i) {
      ...
      std::unique_ptr<Iterator> db_iter(NewDBIterator(
          env_, ro, cf_options, mutable_cf_options, BytewiseComparator(),
          internal_iter, nullptr /* version */, i + 2,
...

  {
...

    {
      ...
      std::unique_ptr<Iterator> db_iter(NewDBIterator(
          env_, ro, cf_options, mutable_cf_options, BytewiseComparator(),
          internal_iter, nullptr /* version */, 202,
          options.max_sequential_skip_in_iterations,
          nullptr /*read_callback*/));
      db_iter->SeekToLast();
      ASSERT_TRUE(db_iter->Valid());
...

  {
    for (size_t i = 0; i < 200; ++i) {
      ...
      std::unique_ptr<Iterator> db_iter(NewDBIterator(
          env_, ro, cf_options, mutable_cf_options, BytewiseComparator(),
          internal_iter, nullptr /* version */, i,
          options.max_sequential_skip_in_iterations,
          nullptr /*read_callback*/));
      db_iter->SeekToLast();
      ASSERT_TRUE(!db_iter->Valid());
    ...
    std::unique_ptr<Iterator> db_iter(NewDBIterator(
        env_, ro, cf_options, mutable_cf_options, BytewiseComparator(),
        internal_iter, nullptr /* version */, 200,
        options.max_sequential_skip_in_iterations, nullptr /*read_callback*/));
    db_iter->SeekToLast();
    ASSERT_TRUE(db_iter->Valid());
    ASSERT_EQ(db_iter->key().ToString(), "c");
...
TEST_F(DBIteratorTest, DBIteratorSkipInternalKeys) {
  ...
  // max_sequential_skip_in_iterations.
  {
    for (size_t i = 1; i <= 200; ++i) {
      ...
      std::unique_ptr<Iterator> db_iter(NewDBIterator(
          env_, ro, cf_options, mutable_cf_options, BytewiseComparator(),
          internal_iter, nullptr /* version */, 2 * i + 1,
          options.max_sequential_skip_in_iterations,
          nullptr /*read_callback*/));
...
TEST_F(DBIteratorTest, DBIterator1) {
  ...
  std::unique_ptr<Iterator> db_iter(NewDBIterator(
      env_, ro, ImmutableCFOptions(options), MutableCFOptions(options),
      BytewiseComparator(), internal_iter, nullptr /* version */, 1,
      options.max_sequential_skip_in_iterations, nullptr /*read_callback*/));
  db_iter->SeekToFirst();
  ASSERT_TRUE(db_iter->Valid());
  ASSERT_EQ(db_iter->key().ToString(), "a");
...
TEST_F(DBIteratorTest, DBIterator2) {
  ...
  std::unique_ptr<Iterator> db_iter(NewDBIterator(
      env_, ro, ImmutableCFOptions(options), MutableCFOptions(options),
      BytewiseComparator(), internal_iter, nullptr /* version */, 0,
      options.max_sequential_skip_in_iterations, nullptr /*read_callback*/));
  db_iter->SeekToFirst();
  ASSERT_TRUE(db_iter->Valid());
  ASSERT_EQ(db_iter->key().ToString(), "a");
...
TEST_F(DBIteratorTest, DBIterator4) {
  ...
  std::unique_ptr<Iterator> db_iter(NewDBIterator(
      env_, ro, ImmutableCFOptions(options), MutableCFOptions(options),
      BytewiseComparator(), internal_iter, nullptr /* version */, 4,
      options.max_sequential_skip_in_iterations, nullptr /*read_callback*/));
  db_iter->SeekToFirst();
  ASSERT_TRUE(db_iter->Valid());
  ASSERT_EQ(db_iter->key().ToString(), "a");
...
TEST_F(DBIteratorTest, DBIterator5) {
...

  {
    ...
    std::unique_ptr<Iterator> db_iter(NewDBIterator(
        env_, ro, cf_options, mutable_cf_options, BytewiseComparator(),
        internal_iter, nullptr /* version */, 1,
        options.max_sequential_skip_in_iterations, nullptr /*read_callback*/));
    db_iter->SeekToLast();
    ASSERT_TRUE(db_iter->Valid());
    ASSERT_EQ(db_iter->key().ToString(), "a");
...

  {
    ...
    std::unique_ptr<Iterator> db_iter(NewDBIterator(
        env_, ro, cf_options, mutable_cf_options, BytewiseComparator(),
        internal_iter, nullptr /* version */, 3,
        options.max_sequential_skip_in_iterations, nullptr /*read_callback*/));
    db_iter->SeekToLast();
    ASSERT_TRUE(db_iter->Valid());
    ASSERT_EQ(db_iter->key().ToString(), "a");
...

  {
    ...
    std::unique_ptr<Iterator> db_iter(NewDBIterator(
        env_, ro, cf_options, mutable_cf_options, BytewiseComparator(),
        internal_iter, nullptr /* version */, 5,
        options.max_sequential_skip_in_iterations, nullptr /*read_callback*/));
    db_iter->SeekToLast();
    ASSERT_TRUE(db_iter->Valid());
    ASSERT_EQ(db_iter->key().ToString(), "a");
...

  {
    ...
    std::unique_ptr<Iterator> db_iter(NewDBIterator(
        env_, ro, cf_options, mutable_cf_options, BytewiseComparator(),
        internal_iter, nullptr /* version */, 6,
        options.max_sequential_skip_in_iterations, nullptr /*read_callback*/));
    db_iter->SeekToLast();
    ASSERT_TRUE(db_iter->Valid());
    ASSERT_EQ(db_iter->key().ToString(), "a");
...
TEST_F(DBIteratorTest, DBIterator7) {
...

  {
    ...
    std::unique_ptr<Iterator> db_iter(NewDBIterator(
        env_, ro, cf_options, mutable_cf_options, BytewiseComparator(),
        internal_iter, nullptr /* version */, 9,
        options.max_sequential_skip_in_iterations, nullptr /*read_callback*/));
    db_iter->SeekToLast();
    ASSERT_TRUE(db_iter->Valid());
...

  {
    ...
    std::unique_ptr<Iterator> db_iter(NewDBIterator(
        env_, ro, cf_options, mutable_cf_options, BytewiseComparator(),
        internal_iter, nullptr /* version */, 13,
        options.max_sequential_skip_in_iterations, nullptr /*read_callback*/));
    db_iter->SeekToLast();
    ASSERT_TRUE(db_iter->Valid());
...

  {
    ...
    std::unique_ptr<Iterator> db_iter(NewDBIterator(
        env_, ro, cf_options, mutable_cf_options, BytewiseComparator(),
        internal_iter, nullptr /* version */, 14,
        options.max_sequential_skip_in_iterations, nullptr /*read_callback*/));
    db_iter->SeekToLast();
    ASSERT_TRUE(db_iter->Valid());
...
TEST_F(DBIteratorTest, DBIterator8) {
  ...
  std::unique_ptr<Iterator> db_iter(NewDBIterator(
      env_, ro, ImmutableCFOptions(options), MutableCFOptions(options),
      BytewiseComparator(), internal_iter, nullptr /* version */, 10,
      options.max_sequential_skip_in_iterations, nullptr /*read_callback*/));
  db_iter->SeekToLast();
  ASSERT_TRUE(db_iter->Valid());
  ASSERT_EQ(db_iter->key().ToString(), "b");
...
TEST_F(DBIteratorTest, DBIterator12) {
  ...
  std::unique_ptr<Iterator> db_iter(NewDBIterator(
      env_, ro, ImmutableCFOptions(options), MutableCFOptions(options),
      BytewiseComparator(), internal_iter, nullptr /* version */, 10, 0,
      nullptr /*read_callback*/));
  db_iter->SeekToLast();
  ASSERT_TRUE(db_iter->Valid());
  ASSERT_EQ(db_iter->key().ToString(), "c");
...
TEST_F(DBIteratorTest, DBIterator13) {
  ...
  std::unique_ptr<Iterator> db_iter(NewDBIterator(
      env_, ro, ImmutableCFOptions(options), MutableCFOptions(options),
      BytewiseComparator(), internal_iter, nullptr /* version */, 2, 3,
      nullptr /*read_callback*/));
  db_iter->Seek("b");
  ASSERT_TRUE(db_iter->Valid());
...
TEST_F(DBIteratorTest, DBIterator14) {
  ...
  std::unique_ptr<Iterator> db_iter(NewDBIterator(
      env_, ro, ImmutableCFOptions(options), MutableCFOptions(options),
      BytewiseComparator(), internal_iter, nullptr /* version */, 4, 1,
      nullptr /*read_callback*/));
  db_iter->Seek("b");
  ASSERT_TRUE(db_iter->Valid());
  ASSERT_EQ(db_iter->key().ToString(), "b");
...
TEST_F(DBIteratorTest, DBIteratorTestDifferentialSnapshots) {
  { // test that KVs earlier that iter_start_seqnum are filtered out
    ...
    std::unique_ptr<Iterator> db_iter(NewDBIterator(
        env_, ro, ImmutableCFOptions(options), MutableCFOptions(options),
        BytewiseComparator(), internal_iter, nullptr /* version */, 13,
...
TEST_F(DBIteratorTest, ReverseToForwardWithDisappearingKeys) {
  ...
  std::unique_ptr<Iterator> db_iter(NewDBIterator(
      ...
      nullptr /* version */, 10, options.max_sequential_skip_in_iterations,
      nullptr /*read_callback*/));
