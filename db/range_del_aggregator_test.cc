...
TEST_F(RangeDelAggregatorTest, SingleIterInAggregator) {
  ...
  VerifyGetEndpoint(
      &range_del_agg,
      {
          {InternalValue("_", kMaxSequenceNumber), {&a, 0}, {nullptr, 0}},
          {InternalValue("a", kMaxSequenceNumber), {&c, 10}, {&a, 10}},
          {InternalValue("a", 0), {&c, 10}, {&a, 10}},
          {InternalValue("c", kMaxSequenceNumber), {&e, 10}, {&c, 10}},
          {InternalValue("e", kMaxSequenceNumber), {&g, 8}, {&e, 8}},
          {InternalValue("g", kMaxSequenceNumber), {nullptr, 0}, {&g, 0}},
      });
...
TEST_F(RangeDelAggregatorTest, MultipleItersInAggregator) {
  ...
  ParsedInternalKey a = {"a", kMaxSequenceNumber, kTypeRangeDeletion},
                    ...
                    i = {"i", kMaxSequenceNumber, kTypeRangeDeletion},
                    ii = {"ii", kMaxSequenceNumber, kTypeRangeDeletion};
  VerifyGetEndpoint(
      &range_del_agg,
      {
          {InternalValue("a", kMaxSequenceNumber), {&b, 20}, {&a, 20}},
          {InternalValue("b", kMaxSequenceNumber), {&c, 10}, {&b, 10}},
          {InternalValue("c", kMaxSequenceNumber), {&e, 10}, {&c, 10}},
          {InternalValue("e", kMaxSequenceNumber), {&g, 8}, {&e, 8}},
          {InternalValue("g", kMaxSequenceNumber), {&h, 0}, {&g, 0}},
          {InternalValue("i", kMaxSequenceNumber), {&ii, 12}, {&i, 12}},
      });
...
TEST_F(RangeDelAggregatorTest, MultipleItersInAggregatorWithUpperBound) {
  ...
  VerifyGetEndpoint(
      ...
      {
          {InternalValue("a", kMaxSequenceNumber), {&c, 10}, {&a, 10}},
          {InternalValue("b", kMaxSequenceNumber), {&c, 10}, {&a, 10}},
          {InternalValue("c", kMaxSequenceNumber), {&e, 10}, {&c, 10}},
          {InternalValue("e", kMaxSequenceNumber), {&g, 8}, {&e, 8}},
          {InternalValue("g", kMaxSequenceNumber), {&ii, 0}, {&g, 0}},
      });
...
TEST_F(RangeDelAggregatorTest, MultipleTruncatedItersInAggregator) {
  ...
  VerifyGetEndpoint(
      &range_del_agg,
      {
          {InternalValue("a", kMaxSequenceNumber), {&a4, 0}, {nullptr, 0}},
          {InternalValue("a", 4), {&m, 10}, {&a4, 10}},
          {InternalValue("m", kMaxSequenceNumber), {&m20, 0}, {&m, 0}},
          {InternalValue("m", 20), {&x, 10}, {&m20, 10}},
          {InternalValue("x", 5), {&z, 10}, {&x5, 10}},
      });
