...
int main(int argc, char** argv) {
  ...
  StartPhase("multi_prefix_exists");
  {
    ...
    rocksdb_multi_prefix_exists(db, roptions, num_prefixes, prefixes,
                                prefix_sizes, results, 0 /* sorted_input */);
    ...
    rocksdb_multi_prefix_exists_cf_slice(
        db, roptions, rocksdb_get_default_column_family_handle(db), 2,
        slice_prefixes, slice_results, 0 /* sorted_input */);
