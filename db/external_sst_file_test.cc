...
TEST_P(ExternalSSTFileTest, IngestFilesTriggerFlushingWithTwoWriteQueue) {
  ...
  // It will trigger flushing memtable and require this thread
  // is currently at the front of the 2nd writer queue. We must make sure that
  // it won't enter the front of the 2nd writer queue for the second time.
