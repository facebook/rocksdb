...
class VersionStorageInfo {
 ...
 private:
  ...
  friend class async::VersionSetGetContext;
...
class Version {
 public:
  ...
  // Helper for async
  InternalIterator* CreateTwoLevelIterator(const ReadOptions&, const EnvOptions& soptions,
 ...
 private:
   ...
   const MergeOperator* merge_operator() const {
     return merge_operator_;
   }
