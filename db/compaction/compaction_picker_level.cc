...
bool LevelCompactionPicker::NeedsCompaction(
  ...
  if (!vstorage->DeletionRatioTriggeredFiles().empty()) {
    return true;
  }
...
class LevelCompactionBuilder {
 public:
  ...
  void PickDeletionRatioTriggeredFiles();
...
void LevelCompactionBuilder::PickDeletionRatioTriggeredFiles() {
  PickFileToCompact(vstorage_->DeletionRatioTriggeredFiles(), true);
}
...
void LevelCompactionBuilder::SetupInitialFiles() {
  ...
  // Deletion ratio triggered compaction
  PickDeletionRatioTriggeredFiles();
  if (!start_level_inputs_.empty()) {
    compaction_reason_ = CompactionReason::kDeletionRatio;
    return;
  }
