...
class ReadOnlyMemTable {
 public:
  ...
  //        Modified by this method: deleted keys found are added to the set.
  //        Callers should pass the same vector through all levels (memtable,
  //        immutable memtables, SST files) to enable cross-level shadowing.
  ...
  //        bounds.
  virtual void MultiPrefixExists(
