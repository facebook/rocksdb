...
uint64_t rocksdb_table_properties_lsm_info_at_creation(
    const rocksdb_table_properties_t* props) {
  return props->rep.lsm_info_at_creation;
}
...
void rocksdb_options_set_dynamic_offpeak_window_percent(rocksdb_options_t* opt,
                                                        uint32_t v) {
  opt->rep.dynamic_offpeak_window_percent = v;
}

uint32_t rocksdb_options_get_dynamic_offpeak_window_percent(
    rocksdb_options_t* opt) {
  return opt->rep.dynamic_offpeak_window_percent;
}
