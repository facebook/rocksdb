...
struct FileMetaData {
  ...
  FileMetaData(uint64_t file, uint32_t file_path_id, uint64_t file_size,
               ...
               uint64_t _file_creation_time, uint32_t _file_checksum, std::string& _file_checksum_name )
...
class VersionEdit {
 public:
  ...
  void AddFile(int level, uint64_t file, uint32_t file_path_id,
               ...
               uint64_t file_creation_time, uint32_t file_checksum, std::string& file_checksum_name) {
    ...
    new_files_.emplace_back(
        level, FileMetaData(file, file_path_id, file_size, smallest, largest,
                            ...
                            oldest_ancester_time, file_creation_time, file_checksum, file_checksum_name));
  }
