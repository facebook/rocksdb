...
enum ValueType : unsigned char {
  ...
  // The indirect types have values that are pointers to the actual
  // location/length of the values is a separate file
  kTypeIndirectValue = 0x1C,
  kTypeIndirectMerge = 0x1D,
...
// These are coded so as to minimize branch misprediction, and to end with a
// fusable test operation
//
