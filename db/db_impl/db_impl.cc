...
// 2. Fence WAL iterators at the failed sequence range and persist its end so a
//    possibly complete record is neither exposed nor allowed to collide with a
//    later write after recovery.
